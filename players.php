<?php
session_start();
if (isset($_POST["host_name"]) and isset($_POST["guest_name"]) and isset($_POST["room_number"])) {
        ...
        if($result->num_rows > 0){    
          ...
          //  echo "<strong>Updating based on parameters above, if none, no results will be displayed below!</strong><br>";
            ...
            //   echo "&#10004 Host name updated to ". $host_name;
                ...
                $sql = "UPDATE accounts SET playerinroom = '$room_number' WHERE username='$host_name'";
                $conn->query($sql);
            //    echo "<br>";
            ...
            if (empty($_POST['guest_name'] == false)){   
              ...
              // echo "&#10004 Guest name updated to ". $guest_name;
                ...
                $sql = "UPDATE accounts SET playerinroom = '$room_number' WHERE username='$guest_name'";
                $conn->query($sql);
              //  echo "<br>";
  ...
  // not all values where selected 
  header("Location: index.php?reset=error", true); exit;
}
?>    